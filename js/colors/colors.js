;(function(window, undefined){
	...
	window.darkenColour = function (p,c0,c1,l) {
    let r,g,b,P,f,t,h,i=parseInt,m=Math.round,a=typeof(c1)=="string";
    if(typeof(p)!="number"||p<-1||p>1||typeof(c0)!="string"||(c0[0]!='r'&&c0[0]!='#')||(c1&&!a))return null;
    if(!this.darkenColour)this.darkenColour=(d)=>{
        let n=d.length,x={};
        if(n>9){
    ...
    h=c0.length>9,h=a?c1.length>9?true:c1=="c"?!h:false:h,f=darkenColour(c0),P=p<0,t=c1&&c1!="c"?darkenColour(c1):P?{r:0,g:0,b:0,a:-1}:{r:255,g:255,b:255,a:-1},p=P?p*-1:p,P=1-p;
    if(!f||!t)return null;
